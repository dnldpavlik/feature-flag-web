...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  close:
    'M12.354 3.646a.5.5 0 010 .708L8.707 8l3.647 3.646a.5.5 0 01-.708.708L8 8.707l-3.646 3.647a.5.5 0 01-.708-.708L7.293 8 3.646 4.354a.5.5 0 11.708-.708L8 7.293l3.646-3.647a.5.5 0 01.708 0z',
  search:
...
export const ICON_FILL_RULES: Partial<Record<IconName, 'evenodd' | 'nonzero'>> = {
  menu: 'evenodd',
  search: 'evenodd',
  flag: 'evenodd',
  list: 'evenodd',
...
export const ICON_CLIP_RULES: Partial<Record<IconName, 'evenodd' | 'nonzero'>> = {
  menu: 'evenodd',
  search: 'evenodd',
  flag: 'evenodd',
  list: 'evenodd',
