...
export class ThemeTabComponent {
  ...
  protected readonly themePreferences = computed(() =>
    this.settingsStore.themePreferences()
  );

  protected readonly currentMode = computed(() => this.themePreferences().mode);
  protected readonly reducedMotion = computed(
    () => this.themePreferences().reducedMotion
  );
  protected readonly compactMode = computed(
    () => this.themePreferences().compactMode
  );
